...
const SCHEDULE_DAY_1: ScheduleItem[] = [
  { time: "", title: "The Asset Architecture", description: "We stop 'creating content' and start creating assets. In this power hour, you will build your high-ticket offer and install the 3 automated referral systems." },
];

const SCHEDULE_DAY_2: ScheduleItem[] = [
  { time: "", title: "The Content & Conversion Engine", description: "We install the 'Infinite Content' matrix to write newsletters in record time, and write the 5-email sequence that turns subscribers into buyers." },
];
...
const FAQ_ITEMS: FAQItem[] = [
  { question: "Is this live or pre-recorded?", answer: "You get access to the COMPLETE HD Recordings of the 100% LIVE Sessions. Ana is showing you the behind-the-scenes of how she operates and answering questions all throughout." },
  ...
  { question: "How long do I have access for?", answer: "Lifetime. You get immediate access to the complete recordings, templates, and community forever. You can implement at your own pace whenever you're ready." },
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-brand-950/90 backdrop-blur border-b border-brand-800' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <span className="text-brand-lime font-mono text-xs uppercase border border-brand-lime/20 bg-brand-lime/5 px-2 py-1 rounded">Instant Access Available</span>
          </div>
        </div>
      </nav>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 flex flex-col justify-center relative z-10">
            <div className="inline-flex items-center gap-2 mb-8">
              ...
              <span className="text-brand-lime font-mono text-sm uppercase tracking-widest">Recorded Implementation Workshop</span>
            </div>
      ...
      <section id="program" className="py-32 bg-brand-900 relative border-t border-brand-800 z-10">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-20 text-center">
            ...
            <p className="text-brand-grey mt-4 text-lg">Two days. One live recording. Zero fluff.</p>
          </div>
      ...
      <section className="py-20 px-4 flex justify-center bg-brand-900 relative overflow-hidden z-10">
        ...
        <div className="max-w-lg w-full text-center relative z-10">
          ...
          <p className="text-brand-grey mb-8">
            Limited spots available at this price point.
