...
export const metadata: Metadata = {
    title: "Unstuck to Published — Build Your Substack The Right Way From Day One | Live Workshop",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: 'Unstuck to Published — Live Substack Workshop with Ana & Jessica',
            },
        ],
    },
    twitter: {
