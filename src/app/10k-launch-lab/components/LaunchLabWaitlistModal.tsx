...
export const LaunchLabWaitlistModal: React.FC<LaunchLabWaitlistModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            {/* Modal Content */}
            <div className="relative bg-white w-full max-w-2xl rounded-3xl overflow-hidden shadow-[0_30px_70px_rgba(0,0,0,0.3)] border border-gray-100 transform transition-all animate-in fade-in zoom-in duration-300">
                {/* Close Button */}
                <button
                    onClick={onClose}
                ...
                <div className="bg-rose-50 p-6 md:p-8 text-center relative overflow-hidden border-b border-gray-100">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-full mb-4 shadow-lg relative z-10 border border-gray-100">
                ...
                <div className="p-8 md:p-12 text-center">
                    <p className="font-poppins font-bold text-xl md:text-2xl text-black leading-tight mb-4">
                        You'll be the <span className="relative inline-block">
                            <span className="absolute inset-0 bg-rose-50 transform -skew-x-12 -z-10"></span>
                    ...
                    <button
                        onClick={onClose}
                        className="w-full bg-black hover:bg-gray-800 text-white font-display font-bold text-lg py-4 rounded-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all uppercase tracking-wider border border-gray-100"
                    >
                        GOT IT, THANKS!
                    </button>
                </div>
