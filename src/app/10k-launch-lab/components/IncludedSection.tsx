    ...
    return (
        <section className="w-full bg-white py-20 px-4 md:px-8 flex flex-col items-center">
            ...
            <div className="max-w-3xl w-full mx-auto space-y-6 mb-12 font-poppins text-lg md:text-xl text-black leading-relaxed">
                <p>
                    If you've been feeling "meh" about showing up online or don't know where to start, The <span className="italic">$10k</span> Launch Lab will solve that.
                </p>
                <p>
                    <span className="font-bold">I'm going to rewire how you think about branding, and give you the clarity, conviction, and strategy to build a vibe people crave.</span>
                </p>
                <p>
                    I'm giving you my exact cult-brand strategy so you can stop traffic, turn heads, and turn your audience into raving fans.
                </p>
                <p>
                    Are you ready to claim your space?
                </p>
            </div>

            {/* 2. Bundle Mockup Visual (Re-used/Adapted layout) */}
            ...
            {/* 3. Included List */}
            <div className="max-w-4xl w-full mx-auto mb-16 text-center md:text-left">
                <h2 className="font-poppins font-bold text-2xl md:text-3xl text-center mb-10 text-black">
                    Here's What's Included:
                </h2>

                <ul className="space-y-4 font-poppins text-base md:text-lg text-black list-disc pl-5 md:pl-20 marker:text-black text-left inline-block">
                    <li>
                        <span className="font-bold">Pre-Recorded Modules</span> (10 lessons, about 1 hour total consumption time)
                    </li>
                    <li>
                        <span className="font-bold">The Launch Lab Sprint Workbook:</span> 66 page workbook designed to get you into action.
                    </li>
                    <li>
                        <span className="font-bold">Archetype Vault Access:</span> discover your actual brand voice <span className="italic">(not the one the gurus tell you to create)</span>
                    </li>
                    <li>
                        <span className="font-bold">Brand Auditor:</span> Built to analyze your brand and help you spot gaps and places you're playing it safe.
                    </li>
                </ul>
            </div>
