...
// Absolute URLs on purpose (see src/app/bootcamp/page.tsx): social crawlers
// need a fully-qualified image URL, and a JPEG — several platforms reject WebP
// for link previews.
const SITE = 'https://www.monetisesubstack.com';
const OG_IMAGE = `${SITE}/imgs/how-to-hit-10k/og.jpg`;
