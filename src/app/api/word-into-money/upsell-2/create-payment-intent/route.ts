...
import { stripe, WIM_UPSELL2_PRICE } from '@/lib/stripe';
    ...
    try {
        ...
        const paymentIntent = await stripe.paymentIntents.create({
            ...
            metadata: {
                ...
                email,
                name,
                product: '10k_launch_lab_from_wim_upsell',
            },
        });
        ...
        console.error('Upsell 2 Stripe Exception:', error);
