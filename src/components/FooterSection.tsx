          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                The proven system that helps newsletter creators build $120K+/year businesses. Join 380+ successful students who've transformed their newsletters into revenue machines.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-300 text-xs">380+ Success Stories</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex flex-col md:flex-row justify-center items-center gap-4 text-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300 text-xs">Trusted by 380+ Newsletter Creators</span>
              </div>
              <div className="hidden md:block w-px h-4 bg-gray-600"></div>
              <div className="flex items-center gap-2">
