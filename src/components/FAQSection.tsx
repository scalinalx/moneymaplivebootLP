  ...
  const faqs = [
    {
      ...
      answer: "The Substack Money Map Bootcamp is just $247 as a one-time payment. That's less than what most people spend on a single dinner out, yet our students are generating $2,000-$8,000+ monthly from their newsletters. Most of our students make back their investment within their first two weeks after the bootcamp by converting free subscribers to paid tiers."
    },
    {
