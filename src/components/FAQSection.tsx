...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Most courses give you theory. We give you the exact templates, frameworks, and strategies that generated over $500k+ for our students. You get proven systems used by 12 Substack Bestsellers, plus a community of 380+ successful newsletter creators who actually implement and see results."
    },
    {
