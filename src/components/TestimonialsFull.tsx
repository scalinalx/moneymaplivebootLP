  ...
  return (
    <div className="mb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-black/20 backdrop-blur-xl rounded-2xl p-8 border border-white/25 hover:border-white/40 transition-colors duration-200">
          <div className="flex items-center gap-4 mb-6">
            <Image src="https://firebasestorage.googleapis.com/v0/b/testimonialto.appspot.com/o/testimonials%2Fa5e4510d-697e-412b-a33e-d5503f645c92%2Favatar?alt=media&token=3a4e4b81-9080-436e-bfae-25808b43fc0f" alt="Sue Bolton" className="w-16 h-16 rounded-full" width={64} height={64} />
            <div>
        ...
        <div className="bg-black/20 backdrop-blur-xl rounded-2xl p-8 border border-white/25 hover:border-white/40 transition-colors duration-200">
          <div className="flex items-center gap-4 mb-6">
            <Image src="/testimavatar/jeff.webp" alt="Jeff" className="w-16 h-16 rounded-full" width={64} height={64} />
            <div>
