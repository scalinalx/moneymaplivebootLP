...
const mainNiches = [
    {
        ...
        description: "You're publishing weekly on Substack, growing your free list, and your readers love your work — but your paid tier is collecting dust. This system turns your existing readership into paying subscribers without changing your writing style.",
    },
    {
        title: "Coaches & Consultants",
        description: "You're using your newsletter to build authority and attract clients — but you've never monetised the newsletter itself. This workshop shows you how to add a paid tier that generates recurring revenue alongside your 1:1 work.",
    },
    {
        title: "Content Creators",
        description: "You're creating across platforms — YouTube, podcasts, social — and Substack is your home base. You have attention but no conversion system. This gives you one, so the audience you've already built starts paying you directly.",
    },
    {
        title: "Digital Educators",
        description: "You teach, share frameworks, or break down complex topics for your readers. Your free content already delivers massive value — which means your paid tier will feel like a natural next step once you structure it using this system.",
    },
];
        ...
        <div className="w-full flex justify-center py-20 px-6 bg-[#FDF2F8]">
            <div className="max-w-[1000px] w-full flex flex-col items-center">
                ...
                <p className="font-lato text-[#333333] text-lg md:text-xl text-center mb-12 max-w-2xl">
                    This workshop works for these <span className="font-bold">four main niches.</span> If you're in one of these four niches, this will be a great fit for you!
                </p>
