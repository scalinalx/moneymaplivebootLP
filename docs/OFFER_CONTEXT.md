# Offer Context: Build to Profit + Money Map (Marketing Brief)

This brief captures the positioning, pricing, timing, and messaging to market both offers clearly and consistently.
...
- Money Map (MM)
  - What it is: The complete strategy system — ICP, offer building, positioning, market segmentation, messaging, copywriting.
  - What it includes: 5 modules, 10+ hours of workshop recordings, 50+ templates and frameworks, tools and community; lifetime access.
  - What it solves: Strategic clarity and the “perfect offer” you’ll implement in BTP.
...
- Module 1 - Your Subscriber Conversion Machine
- Module 2 - Your Perfect Paywall Strat & Multi-Modal Rev
- Module 3 - Multiple Income Streams Blueprint
- Module 4 - The Disaster Method
- Module 5 - The Anti-Sell System

### Money Map Bonuses

- 5+ Bonuses. Over 50 Toolkits!
- How I optimise my Home page for conversions
- The Infinite Newsletter Idea Generator Prompt
- The 5-mins Growth Ritual
- About page Template
- 3 Key Mindset Shifts For New Income
...
- Strategy vs. Implementation
  ...
  - BTP gets you live execution: ship in 12 days, make sales, and build momentum.

- Speed to Results
  - Cohort energy, accountability partners, real‑time feedback, templates, and launch sequences designed to produce ROI quickly.

- Proof and Confidence
  - Concrete outcomes (revenue wins), lifetime access to recordings/templates, secure checkout, clear next steps after purchase.

## Why Bundle Money Map with Build to Profit

- Strategy first, execution second: Money Map builds your ICP, offer, positioning, segmentation, messaging, and copy — the exact inputs Build to Profit assumes so the 12‑day launch plan can move fast and hit hard.
- Launch the right offer: Without MM, you risk executing BTP on a weak or mismatched offer. With MM, you arrive Nov 18–19 with a refined “perfect offer” ready to ship.
- Higher conversion, more revenue: Sharper positioning + message‑market fit = more sales, higher LTV, and better retention. BTP’s sequences work best when MM’s strategy work is done.
...
- High‑Value Newsletter Club — $397 value
- Extra Bonuses Pack - $520 value
- Special !!! Build To Profit Bonus included = Notes To Cash Workshop! $197 value

Estimated TOTAL value: ≈ $3,000+
